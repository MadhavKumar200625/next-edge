...
export const metadata = {
  title: "Refund Policy | NextEdge Talent Consultancy",
  description:
    "Refund Policy governing the use of the NextEdge Talent Consultancy platform.",
};
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-600">
            Please read this Refund Policy carefully before using the
